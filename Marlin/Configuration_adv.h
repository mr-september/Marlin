...
#define CUSTOM_MENU_MAIN
  ...
  #define CUSTOM_MENU_MAIN_TITLE "Ideagen3D Tools"
  //#define CUSTOM_MENU_MAIN_SCRIPT_DONE ""
  #define CUSTOM_MENU_MAIN_SCRIPT_AUDIBLE_FEEDBACK
  #define CUSTOM_MENU_MAIN_SCRIPT_RETURN   // Return to status screen after a script
  #define CUSTOM_MENU_MAIN_ONLY_IDLE         // Only show custom menu when the machine is idle

  #define MAIN_MENU_ITEM_1_DESC "Service Mode Park"
  #define MAIN_MENU_ITEM_1_GCODE "M117 Parking Hotend \n G28 \n G91 \n G1 X150 Y200 F2000 \n G1 Z250 \n  M84 XY "
  #define MAIN_MENU_ITEM_1_CONFIRM          // Show a confirmation dialog before this action

  #define MAIN_MENU_ITEM_2_DESC "Load"
...
#define CUSTOM_MENU_CONFIG
  ...
  #define CUSTOM_MENU_CONFIG_TITLE "Thermistor Selection"
  #define CUSTOM_MENU_CONFIG_SCRIPT_DONE "M117 Thermistor Updated"
  #define CUSTOM_MENU_CONFIG_SCRIPT_AUDIBLE_FEEDBACK
  #define CUSTOM_MENU_CONFIG_SCRIPT_RETURN  // Return to status screen after a script
  #define CUSTOM_MENU_CONFIG_ONLY_IDLE        // Only show custom menu when the machine is idle

  #define CONFIG_MENU_ITEM_1_DESC "Stock Thermistor"
  #define CONFIG_MENU_ITEM_1_GCODE "M305 R4700 T100000 B4092"
  #define CONFIG_MENU_ITEM_1_CONFIRM        // Show a confirmation dialog before this action

  #define CONFIG_MENU_ITEM_2_DESC "E3D Thermistor"
  #define CONFIG_MENU_ITEM_2_GCODE "M305 R4700 T100000 B4267"
...
//#define CUSTOM_USER_BUTTONS
  ...
  #define BUTTON1_PIN PA4
    ...
    #define BUTTON1_GCODE         "M302 P1\nG4 S1\nG1 E9 F500\nM109 S215\nG1 E50 F500\nM302 P0"
    #define BUTTON1_DESC          "Autoload"  // Optional string to set the LCD status
  #endif
